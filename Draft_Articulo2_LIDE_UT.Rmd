...
df_analisis_UT2020_plot1 <-  df_analisis_UT2020 %>%
...
```{r}
df_analisis_UT2020_plot2 <-  df_analisis_UT2020 %>%
...
df_analisis_UT2020_plot2
```


```{r}
df_analisis_UT2020_plot3 <-  df_analisis_UT2020 %>%
  filter( s6p4_factor == "Si" | s6p4_factor == "No" ) %>% 
...
df_analisis_UT2020_plot3
```


```{r}
df_analisis_UT2020_plot4 <-  df_analisis_UT2020 %>%
  filter( s6p4_factor == "Si" | s6p4_factor == "No" ) %>% 
...
df_analisis_UT2020_plot4
```


```{r}
df_analisis_UT2020_plot5 <-  df_analisis_UT2020 %>%
  filter( s6p4_factor == "Si" | s6p4_factor == "No" ) %>% 
...
```{r}
ggplot(df_analisis_UT2020_plot1, aes(x = promedio_horas_deporte , y = s1p2_factor)) + 
...
```{r}
ggplot(df_analisis_UT2020_edad_summary, aes(x = promedio_horas_deporte, y = rango_edad_10_UT2020)) + 
  labs(title = "Promedio de horas semanales de actividad física por edad en 2020") +
  geom_segment(aes(xend =0, yend = rango_edad_10_UT2020), size = 2, color = "lightblue") +
  geom_point(size = 8, color = "blue") + 
  geom_text(aes(label = round(promedio_horas_deporte, digits = 1.5)), color ="white", size = 3) +
  theme_classic() +
  theme(axis.line.y = element_blank(),
