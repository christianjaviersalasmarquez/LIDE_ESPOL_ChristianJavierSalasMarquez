...
Para ejecutar este análisis, usé las encuestas del uso del tiempo del 2012 y 2019 que levantó el INEC. En estos levantamientos, se hicieron preguntas a los ecuatorianos. Ambas encuestas son representativas a nivel nacional y a nivel de provincia. En este artículo, realicé los cálculos de las medias ponderadas de horas semanales dedicado a cocinar o preparar alimentos separando por las variables categóricas de sexo, provincia y grupo de edad.
...
En el 2012, se puede observar que, en promedio, las mujeres dedicaron 8.34 horas semanales en cocinar o preparar alimentos. Por otro lado, los hombres solo dedicaron 0.88 horas semanales.

En el 2019, podemos observar que, en promedio, las mujeres dedicaron 6.43 horas semanales en cocinar o preparar alimentos. Por otro lado, los hombres solo dedicaron 1.59 horas semanales.
...
ggplot( df_t_cocina_UT2012_plot2 , aes(x = media_ponderada_horas_cocina , y = rango_edad_10_UT2012 )) + 
  ...
  labs(title = "Tiempo semanal en cocinar o preparar alimentos por grupo de edad 2012 (horas)", caption = "") +
...
ggplot( df_t_cocina_UT2019_plot2 , aes(x = media_ponderada_horas_cocina , y = rango_edad_10_UT2019 )) + 
  geom_bar(stat = 'identity', position = 'dodge', fill = "lightblue") + 
  labs(title = "Tiempo semanal en cocinar o preparar alimentos 2019 (horas)", caption = "") +
  geom_text(aes(label = round(media_ponderada_horas_cocina, digits = 2)  ), color ="black", size = 4,position = position_dodge(0.9),hjust = 0) +
  xlab("Media ponderada de horas") +
  ylab("Grupo de edad") +
  theme_classic()
...
ggplot( df_t_cocina_UT2012_plot3 , aes(x = media_ponderada_horas_cocina , y = rango_edad_10_UT2012 , fill = P02_factor )) + 
  ...
  labs(title = "Tiempo semanal en cocinar o preparar alimentos en el 2012 (horas)", caption = "", fill = "Sexo") +
...
ggplot( df_t_cocina_UT2019_plot3 , aes(x = media_ponderada_horas_cocina , y = rango_edad_10_UT2019 , fill = s1p2_factor )) + 
  geom_bar(stat = 'identity', position = 'dodge') + 
  scale_fill_manual(values =c("#5B7DB1","#FFAC8E")) +
  labs(title = "Tiempo semanal en cocinar o preparar alimentos 2019 (horas)", caption = "", fill = "Sexo") +
  geom_text(aes(label = round(media_ponderada_horas_cocina, digits = 2)  ), color ="black", size = 4,position = position_dodge(0.9), hjust = 0) +
  xlab("Media ponderada de horas") +
  ylab("Grupo de edad") +
  theme_classic()
...
ggplot( df_t_cocina_UT2019_plot3 , aes(x = media_ponderada_horas_cocina , y = rango_edad_10_UT2019 , fill = s1p2_factor )) + 
  ...
  labs(title = "Tiempo semanal en cocinar o preparar alimentos en el 2019 (horas)", caption = "", fill = "Sexo") +
  xlab("Proporción") +
  ylab("Grupo de edad") +
  theme_classic()
...
ggplot( df_t_cocina_UT2012_plot4 , aes(x = media_ponderada_horas_cocina , y = reorder(provincia_UT2012, media_ponderada_horas_cocina) )) + 
  geom_bar(stat = 'identity', position = 'dodge', fill = "lightblue") + 
  labs(title = "Tiempo semanal en cocinar en el 2012 (horas)", caption = "") +
  geom_text(aes(label = round(media_ponderada_horas_cocina, digits = 2)  ), color ="black", size = 4,position = position_dodge(0.9), hjust = 0.4) +
  xlab("Media ponderada de horas") +
  ylab("Provincia") +
  theme_classic()
...
ggplot( df_t_cocina_UT2012_plot5 , aes(x = media_ponderada_horas_cocina , y = provincia_UT2012 , fill = P02_factor )) + 
  geom_bar(stat = 'identity', position = 'dodge') + 
  labs(title = "Tiempo semanal en cocinar o preparar alimentos 2012 (horas)", caption = "", fill = "Sexo") +
  geom_text(aes(label = round(media_ponderada_horas_cocina, digits = 2)  ), color ="black", size = 4,position = position_dodge(0.9), hjust = 0) +
  xlab("Media ponderada de horas") +
  ylab("Provincia") +
  theme_classic()
...
En el 2019 a comparación del 2012, podemos encontrar mayor variabilidad en las proporciones de horas dedicadas a la cocina por sexo en cada provincia. En la mayoría de provincias, ha aumentado el aporte del promedio de horas semanales de los hombres en comparación con el gráfico del 2012.
...
ggplot( data.frame(año,h,m)  , aes(x = año) ) + 
  geom_line(aes(y = h, colour = 'Hombres')) + geom_point(aes(y = h)) + 
  geom_line(aes(y = m, colour = 'Mujeres')) + geom_point(aes(y = m)) + 
  labs(title = "Tiempo promedio semanal en cocinar y preparar alimentos por sexo en 2012 vs 2019 (horas)") +
  theme_classic()
```
...
INTRODUCIR LOS RESULTADOS POR SERIE DE TIEMPO, PARA LUEGO PRESENTAR LOS OTROS. AL DE SERIE DE TIEMPO INCLUIR LAS DESVIACIONES (LA PONDERADA). SOLO EN LA SERIE DE TIEMPO. EN LUGAR DE TIEMPO, COLOCAR AÑO.
