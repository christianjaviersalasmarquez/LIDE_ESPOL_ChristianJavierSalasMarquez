...
# Comparaciones de participacion 2012 y 2019
...
```{r}
tiempo <- c(2012, 2019)
h <- c(27348.17	, 26220.93)
m <- c(264798.17, 111921.10	)

df_ts <- data.frame(tiempo,h,m)

ggplot( df_ts, aes(x = tiempo) ) + geom_line(aes(y = h, colour = 'Hombres')) + geom_line(aes(y = m, colour = 'Mujeres')) + labs(title = "Horas semanales en cocinar y preparar alimentos por sexo en 2012 vs 2019")
