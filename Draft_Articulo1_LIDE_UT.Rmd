...
# Podemos estudiar las proporciones. En el 2019, el 54% de los hombres encuestados respondieron que si cocinó o preparó alimentos, mientras que el 89% de las mujeres encuestadas respondieron que si.
...
ggplot( df_t_cocina_UT2012_plot1 , aes(x = P02_factor , y = media_ponderada_horas_cocina, fill = P02_factor )) + 
  geom_bar(stat = 'identity', position = 'dodge') + 
  labs(title = "Tiempo semanal en cocinar o preparar alimentos por sexo en el 2012 (horas)", caption = "Fuente: INEC", fill = "Sexo") +
...
ggplot( df_t_cocina_UT2012_plot2 , aes(x = media_ponderada_horas_cocina , y = rango_edad_10_UT2012 )) + 
  ...
  labs(title = "Tiempo semanal en cocinar o preparar alimentos por grupo de edad 2012 (horas)", caption = "Fuente: INEC") +
...
Considerando los grupos de edades, podemos ver que el grupo de edad entre 50 y 59 años es el que acumula la mayor cantidad de horas promedio semanales en cocinar o preparar alimentos con 6.655 horas. Le sigue el grupo de personas que tienen 30 y 39 años.

```{r echo=FALSE}
ggplot( df_t_cocina_UT2012_plot3 , aes(x = media_ponderada_horas_cocina , y = rango_edad_10_UT2012 , fill = P02_factor )) + 
  geom_bar(stat = 'identity', position = 'dodge') + 
  labs(title = "Tiempo semanal en cocinar o preparar alimentos en el 2012 (horas)", caption = "Fuente: INEC", fill = "Sexo") +
...
ggplot( df_t_cocina_UT2012_plot4 , aes(x = media_ponderada_horas_cocina , y = reorder(provincia_UT2012, media_ponderada_horas_cocina) )) + 
  geom_bar(stat = 'identity', position = 'dodge', fill = "lightblue") + 
  labs(title = "Tiempo semanal en cocinar en el 2012 (horas)", caption = "Fuente: INEC") +
  geom_text(aes(label = round(media_ponderada_horas_cocina, digits = 2)  ), color ="black", size = 4,position = position_dodge(0.9), hjust = 0.2) +
  xlab("Media ponderada de horas") +
  ylab("Provincia") +
  theme_classic()
```
...
ggplot( df_t_cocina_UT2012_plot5 , aes(x = media_ponderada_horas_cocina , y = provincia_UT2012 , fill = P02_factor )) + 
  geom_bar(stat = 'identity', position = 'dodge') + 
  labs(title = "Tiempo semanal en cocinar o preparar alimentos 2012 (horas)", caption = "Fuente: INEC", fill = "Sexo") +
  geom_text(aes(label = round(media_ponderada_horas_cocina, digits = 2)  ), color ="black", size = 4,position = position_dodge(0.9), hjust = 0) +
  xlab("Media ponderada de horas") +
  ylab("Provincia") +
  theme_classic()
...
```{r echo=FALSE}
# Gráfico provisional para ver las proporciones
ggplot( df_t_cocina_UT2012_plot5 , aes(x = media_ponderada_horas_cocina , y = provincia_UT2012 , fill =  P02_factor  )) + 
  geom_bar(stat = 'identity', position = 'fill') + 
  labs(title = "Tiempo semanal en cocinar o preparar alimentos 2012 (horas)", caption = "Fuente: INEC", fill = "Sexo") +
  xlab("Proporción") +
...
ggplot( df_t_cocina_UT2019_plot1 , aes(x = s1p2_factor , y = media_ponderada_horas_cocina, fill = s1p2_factor )) + 
  geom_bar(stat = 'identity', position = 'dodge') + 
  labs(title = "Tiempo semanal en cocinar o preparar alimentos 2019 (horas)", caption = "Fuente: INEC", fill = "Sexo") +
  geom_text(aes(label = round(media_ponderada_horas_cocina, digits = 2)  ), color ="black", size = 4,position = position_dodge(0.9),vjust = -0.2) +
  xlab("Sexo") +
  ylab("Media ponderada de horas") +
  theme_classic()
...
ggplot( df_t_cocina_UT2019_plot2 , aes(x = media_ponderada_horas_cocina , y = rango_edad_10_UT2019 )) + 
  geom_bar(stat = 'identity', position = 'dodge', fill = "lightblue") + 
  labs(title = "Tiempo semanal en cocinar o preparar alimentos 2019 (horas)", caption = "Fuente: INEC") +
  geom_text(aes(label = round(media_ponderada_horas_cocina, digits = 2)  ), color ="black", size = 4,position = position_dodge(0.9),hjust = 0) +
  xlab("Media ponderada de horas") +
  ylab("Grupo de edad") +
  theme_classic()
...
Considerando los grupos de edades, podemos ver que el grupo de edad entre 50 y 59 años es el que acumula la mayor cantidad de horas promedio semanales en cocinar o preparar alimentos con 5.42 horas. Le sigue el grupo de personas que tienen 40 y 49 años con 5.37 horas.
...
ggplot( df_t_cocina_UT2019_plot3 , aes(x = media_ponderada_horas_cocina , y = rango_edad_10_UT2019 , fill = s1p2_factor )) + 
  geom_bar(stat = 'identity', position = "fill") + 
  labs(title = "Tiempo semanal en cocinar o preparar alimentos en el 2019 (horas)", caption = "Fuente: INEC", fill = "Sexo") +
  xlab("Proporción") +
  ylab("Grupo de edad") +
  theme_classic()
```
...
ggplot( df_t_cocina_UT2019_plot5 , aes(x = media_ponderada_horas_cocina , y = provincia_UT2019 , fill = s1p2_factor )) + 
  ...
  labs(title = "Tiempo semanal en cocinar o preparar alimentos 2019 (horas)", caption = "Fuente: INEC", fill = "Sexo") +
  geom_text(aes(label = round(media_ponderada_horas_cocina, digits = 2)  ), color ="black", size = 4,position = position_dodge(0.9)) +
  xlab("Media ponderada de horas") +
  ylab("Provincia") +
  theme_classic()
```
