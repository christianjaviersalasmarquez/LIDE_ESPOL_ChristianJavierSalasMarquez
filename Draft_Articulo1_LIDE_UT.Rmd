...
ggplot( df_t_cocina_UT2012_plot5 %>% filter(provincia_UT2012 != 'Zonas no delimitadas') , aes(x = media_ponderada_horas_cocina , y = provincia_UT2012 , fill =  P02_factor  )) + 
  ...
  theme_classic()
,
ggplot( df_t_cocina_UT2019_plot5 %>% filter(provincia_UT2019 != 'Galápagos' & provincia_UT2019 != 'Zonas no delimitadas')  , aes(x = media_ponderada_horas_cocina , y = provincia_UT2019 , fill = s1p2_factor )) + 
  geom_bar(stat = 'identity', position = 'fill') + 
  scale_fill_manual(values =c("#647A8F","#FFAC8E")) +
