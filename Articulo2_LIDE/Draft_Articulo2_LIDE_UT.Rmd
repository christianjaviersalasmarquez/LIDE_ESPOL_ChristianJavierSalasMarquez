...
Podemos ejecutar este análisis utilizando las siguientes bases de datos del Instituto Nacional de Estadística y Censos INEC:
...
En particular, la pregunta estudiada en este artículo es: En la semana pasada ¿Hizo ejercicios o practicó algún deporte? y ¿Cuánto tiempo?, siendo esta última pregunta realizada sólo si el encuestado responde que sí a la primera pregunta, consultando si es que el encuestado ha hecho ejercicio. Luego, calculamos el promedio ponderado de horas semanales que los ecuatorianos dedican a hacer ejercicio o practicar deporte. Finalmente, analizamos cómo ha evolucionado este promedio comparando los resultados del año 2012 con los del 2019 y 2020. Sin embargo, es importante aclarar que en las preguntas realizadas en las encuestas estudiadas, la pregunta no especifica si el ejercicio realizado es moderado o intenso.
...
Para esta visualización, la primera observación importante que podemos destacar es que en todos los grupos de edad, los hombres dedican una mayor cantidad de horas semanales a la actividad física en comparación con las mujeres. 

Además, podemos destacar es que existe una tendencia en la cual el promedio de horas semanales en hacer ejercicio o practicar deporte disminuye a medida que aumenta el grupo de edad, tanto en hombres como en mujeres. Sin embargo, en el caso de los hombres, esta reducción en el promedio es mayor que el de las mujeres. Por ejemplo, en el 2012 los hombres que tienen entre 12 y 19 años dedicaron 1.87 horas semanales a la actividad física mientras que los hombres del grupo de edad de personas entre 50 y 59 años dedicaron solo 0.44 horas semanales. Esto es una reducción de `r (1.87 - 0.44)` horas semanales para los hombres entre los grupos de edad mencionados. Realizando un cálculo análogo para el caso de las mujeres (considerando el mismo año y los mismos grupos de edad), vemos que existe una reducción de `r (0.61 - 0.24)` horas semanales.
...
Además, aunque Guayas sea la provincia que tiene el menor tiempo promedio tanto para hombres y mujeres, la provincia tiene la menor diferencia con 0.47 horas, comparado con las otras dos. En el año 2020 esta diferencia se mantiene a un valor muy cercano, es decir a `r (0.78 - 0.33)` horas a pesar de que los hombres y mujeres hayan reducido sus horas semanales.

### Conclusiones

Hemos encontramos resultados interesantes en este análisis. Primero, para todas las categorías analizadas en este artículo, observamos que los hombres dedican más tiempo semanal promedio a hacer ejercicio o deporte que las mujeres en todos los casos. Relacionado con esto, los hombres jóvenes que tienen entre 20 y 29 años tienden a alcanzar el nivel mínimo recomendado de 1.25 horas semanales en hacer actividad física aeróbica intensa. Finalmente, considerando hombres y mujeres pudimos observar que las personas más jóvenes son las que más tiempo semanal dedican en hacer ejercicio o practicar algún deporte. 

En el perfil de [GitHub](https://github.com/christianjaviersalasmarquez/LIDE_ESPOL_Christian_Salas/blob/main/Draft_Articulo2_LIDE_UT.Rmd) del autor, podrás revisar el código, reproducir el análisis y encontrar cálculos que pueden generar gráficos adicionales.

### Notas metodológicas importantes

(1) La primera encuesta utilizada fue levantada en el año 2012, se ejecutó con el nombre de 'Encuesta Específica de Uso del Tiempo', la cual tiene un tamaño muestral de 22968 viviendas, cuya población objetivo son las personas de 12 años y más. El período de levantamiento fue entre noviembre y diciembre de 2012. La segunda encuesta utilizada es la Encuesta Nacional Multipropósito de Hogares 2019, la cual fue levantada en el año 2019. La población objetivo abarca los hogares y personas constituidas por personas de 5 años y más. El tamaño muestral fue de 12072 viviendas. La tercera encuesta utilizada fue levantada en el año 2020. En la Encuesta Nacional Multipropósito de Hogares la población objetivo abarca los hogares y personas constituidas por personas de 5 años y más. El tamaño muestral fue de 12060 viviendas. La fase de recolección de la Encuesta Nacional Multipropósito del año 2020 fue entre el 1 de diciembre de 2020 y el 23 de diciembre de 2020. 
